...
@implementation BaiKeSicknessFoldCategoryView
...
- (IBAction)unfoldBtnPress:(id)sender {
    if (self.delegate && [self.delegate respondsToSelector:@selector(onSelectUnfold)]) {
        [self.delegate onSelectUnfold];
    }
